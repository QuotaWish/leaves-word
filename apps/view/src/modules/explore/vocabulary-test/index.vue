...
import { ElCard, ElButton, ElProgress, ElDialog, ElSelect, ElOption } from 'element-plus'
...
const testMode = ref('comprehensive')
  ...
  words.forEach((word, index) => {
    ...
    // 多项选择
      ...
      questions.push({
        ...
        options,
        answer: correctAnswer,
        explanation: 'This is a placeholder explanation. In a real application, there would be a meaningful explanation here.'
      })
    }
  })
...
const accuracy = computed(() => {
  if (userAnswers.value.filter(a => a !== null).length === 0) return 0
    ...
    <div v-if="testStarted && !testCompleted" class="VocabularyTestPage-Test">
      <div class="VocabularyTestPage-StatusBar">
        <div class="VocabularyTestPage-Progress">
          ...
          <ElProgress :percentage="progress" :stroke-width="8" />
        </div>
    ...
    <div v-else-if="testCompleted" class="VocabularyTestPage-Results">
      <ElCard class="VocabularyTestPage-ResultsCard">
        ...
        <div class="VocabularyTestPage-Actions">
          <ElButton @click="showAnalysis" type="primary" class="VocabularyTestPage-AIButton">
            <div class="i-carbon-machine-learning-model"></div>
            AI词汇能力分析
          </ElButton>

          <ElButton @click="restartTest" plain class="VocabularyTestPage-RestartButton">
    ...
    >
      <div class="VocabularyTestPage-StartDialog">
        ...
        <div class="VocabularyTestPage-LevelSelect">
          <span>选择词汇级别：</span>
          <ElSelect v-model="selectedLevel" placeholder="选择词汇级别">
            <ElOption
        ...
        <div class="VocabularyTestPage-StartActions">
          <ElButton @click="startTest" type="primary">
            开始测试
          </ElButton>
        </div>
      </div>
