...
.PersonalHeaderDisplay-Background {
  ...
  &::before {
    ...
    right: 0;
    bottom: 0;
    background-image: linear-gradient(to bottom, var(--theme-color-primary), rgba(0, 0, 0, 0));
    pointer-events: none;
    opacity: 0.9;

    .light & {
      background-image: linear-gradient(to bottom, var(--theme-color-primary), rgba(255, 255, 255, 0));
      opacity: 0.7;
    }
  }
