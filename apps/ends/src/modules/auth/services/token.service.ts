...
export class TokenService {
  ...
  async renewToken(refreshToken: RefreshTokenEntity) {
    const now = dayjs()
    // 判断refreshToken是否过期
    ...
    const user = res.user // await this.verifyAccessToken(refreshToken.value)
    ...
    console.log('=== renew token', user, refreshToken)
  ...
  async refreshToken(accessToken: AccessTokenEntity) {
    ...
    console.log('=== refresh token', user, refreshToken, accessToken)
