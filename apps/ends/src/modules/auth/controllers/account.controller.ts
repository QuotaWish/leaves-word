...
import type { LoginLogQueryDto } from '~/modules/system/log/dto/log.dto'
import { LoginLogInfo } from '~/modules/system/log/models/log.model'
...
export class AccountController {
  ...
  async userLoginLogPage(
    @AuthUser() user: IAuthUser,
    @Query() dto: LoginLogQueryDto,
  ): Promise<Pagination<LoginLogInfo>> {
    return this.loginLogService.listUser(user.uid, dto)
  }
}
