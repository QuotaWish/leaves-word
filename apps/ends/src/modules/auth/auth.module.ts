...
const providers = [AuthService, TokenService, CaptchaService, SubscribeService]
const strategies = [LocalStrategy, JwtStrategy]

@Module({
  imports: [
    TypeOrmModule.forFeature([AccessTokenEntity, RefreshTokenEntity, SubscriptionPlanEntity]),
    PassportModule,
